...
exports.fetchHomeHotels = exports.SaveBookingDetails = exports.StripePayment = exports.fetchHotelById = exports.fetchHotels = void 0;
...
const fetchHomeHotels = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.fetchHomeHotels = fetchHomeHotels;
const fetchHotels = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const hotels = yield hotel_1.default.find(query)
            ...
            .skip(skip)
            .limit(pageSize);
        const total = yield hotel_1.default.countDocuments();
        const response = {
            data: hotels,
            pagination: {
                total,
...
const fetchHotelById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const SaveBookingDetails = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.SaveBookingDetails = SaveBookingDetails;
