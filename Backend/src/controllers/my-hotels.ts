...
const myHotels = async (req: Request, res: Response) => {
  try {
    ...
    logEvents(`${req.method}\t${req.url}\t${req.headers.origin}`, 'myHotels.log')
...
export { myHotels,viewHotels, viewHotelById, updateHotelById };
